...
class PatternDllOpen64(Pattern64):
    def __init__(self, fetch_num = 0) -> None:
        super().__init__()
    ...
    def to_code(self):
        return b"\x61"  + self.fetch_num.to_bytes(self.__class__._size, "big")

class PatternGetSymbol64(Pattern64):
    def __init__(self, fetch_num = 0) -> None:
        super().__init__()
    ...
    def to_code(self):
        return b'\x62' + self.fetch_num.to_bytes(self.__class__._size, "big")

class PatternCCall64(Pattern64):
    def __init__(self, fetch_num = 0) -> None:
        super().__init__()
...
class PatternDllOpen32(Pattern32):
    def __init__(self, fetch_num = 0) -> None:
        super().__init__()
...
class PatternGetSymbol32(Pattern32):
    def __init__(self, fetch_num = 0) -> None:
        super().__init__()
...
class PatternCCall32(Pattern32):
    def __init__(self, fetch_num = 0) -> None:
        super().__init__()
